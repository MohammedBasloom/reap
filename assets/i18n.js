...
(function () {
  ...
  const D = {
    ...
    "— whatever remains after covering the month's own costs — sweeps against accrued interest first, then principal, until the loan is fully closed. Any residual balance at the project's natural exit month is force-cleared from exit proceeds.": "— ما يتبقى بعد تغطية تكاليف الشهر نفسه — يُمسح أولًا مقابل الفوائد المستحقة ثم أصل الدين حتى إغلاق القرض بالكامل، وأي رصيد متبقٍ عند شهر التخارج الطبيعي يُسدَّد من عوائد التخارج.",
    "Funding order:": "ترتيب التمويل:",
    "each month's income (e.g. off-plan sales) covers that month's costs first; any shortfall is drawn from the facility with interest capitalising until the cap, and equity covers the remainder. Surplus income sweeps the loan — interest first, then principal.": "دخل كل شهر (مثل مبيعات ما قبل الإنشاء) يغطي تكاليف الشهر نفسه أولًا؛ وأي عجز يُسحب من التسهيلات مع رسملة الفوائد حتى السقف، وتغطي الملكية المتبقي. وفائض الدخل يُسدِّد القرض — الفوائد أولًا ثم أصل الدين.",
